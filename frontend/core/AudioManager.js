...
export class AudioManager {
  constructor() {
    ...
    // Volume settings (0-1) - VERY quiet background
    this.musicVolume = 0.05;      // Very quiet background music (was 0.15)
    this.ambientVolume = 0.03;    // Barely audible ambient (was 0.1)
