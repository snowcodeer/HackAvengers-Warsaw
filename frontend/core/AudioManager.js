...
export class AudioManager {
  constructor() {
    ...
    // Volume settings (0-1) - Noticeable but not overpowering
    this.musicVolume = 0.25;      // Background music - radio/pop feel
    this.ambientVolume = 0.15;    // Ambient sounds - café atmosphere
